                    ...
                    <div className="relative bg-[#11131a]/90 backdrop-blur-xl rounded-3xl p-8 md:p-12 h-full flex flex-col">
                        ...
                        <form className="flex flex-col gap-10" onSubmit={(e) => e.preventDefault()}>
                            <div className="relative">
                                <input type="text" id="name" placeholder="Your Name" className="w-full bg-transparent border-b border-white/10 pb-3 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-cyan-400 transition-colors peer" />
                            </div>
                            <div className="relative">
                                <input type="email" id="email" placeholder="Email Address" className="w-full bg-transparent border-b border-white/10 pb-3 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-cyan-400 transition-colors peer" />
                            </div>
                            <div className="relative mb-4">
                                <textarea id="message" placeholder="Your Message" rows="4" className="w-full bg-transparent border-b border-white/10 pb-3 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-cyan-400 transition-colors resize-none peer"></textarea>
                            </div>

                            <button type="submit" className="ml-auto bg-gradient-to-r from-cyan-400 to-blue-600 text-white text-xs font-bold uppercase tracking-wider py-3.5 px-8 rounded-xl flex items-center gap-3 hover:scale-105 transition-transform duration-300 shadow-[0_0_20px_rgba(34,211,238,0.3)]">
                                Send Message
