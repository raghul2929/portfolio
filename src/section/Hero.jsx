    ...
    <section id="hero"  data-guide-id="hero" className="relative min-h-[100svh] flex flex-col items-center justify-center px-6 pb-2 md:pb-16 overflow-hidden">
      ...
      {/* CTAs - Slightly reduced vertical padding so they don't look chunky at 100% */}
        <div className="flex flex-col sm:flex-row items-center gap-4 mt-8 z-10 w-full sm:w-auto">
          ...
          <a href="/assets/Raghulk.pdf" download className="w-full sm:w-auto bg-transparent border border-white/20 text-white px-8 py-3.5 rounded-xl font-semibold flex items-center justify-center gap-2 hover:bg-white/5 transition-colors">
